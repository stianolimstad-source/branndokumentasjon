...
export const layerMaterials: LayerMaterial[] = [
  ...
  // ── Isolasjon ──
  {
    ...
    category: "isolasjon",
    factor: 0.2,
    standardThicknesses: [45, 50, 70, 95, 100, 120, 145, 148, 198, 200, 250],
...
export const massiveWallTypes: MassiveWallType[] = [
  {
    ...
    ref: "EN 1992-1-2:2004, Tabell 5.3 (ikke-bærende vegger, EI-krav)",
    notes: "For bærende vegger (REI) kreves normalt større tykkelse. Verdier gjelder silika-tilslagsmateriale.",
  },
  {
    id: "lettbetong",
