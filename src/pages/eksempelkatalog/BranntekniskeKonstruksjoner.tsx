...
const ei60Kategorier: Kategori[] = [
  {
    ...
    eksempler: [
      {
        navn: "Norgips W112 Stålstender — Dobbel gipsplatekledning",
        kortbeskrivelse: "Dobbel gips på stålstender. Dokumentert EI 60.",
        beskrivelse: "Ikke-bærende branncellevegg med stålstendere og dobbel gipsplatekledning (2/2) på begge sider. Dokumentert EI 60 iht. Norgips veggtabell for W112 stålstender.",
        oppbygging: [
          "2× 12,5 mm Norgips Standard / Hard / Humidboard (hver side)",
          "Stålstender Norgips dB+ c/c 450 eller 600 mm",
        ...
        leverandor: "Norgips",
        referanse: "Norgips Veggtabell – W112 Stålstender",
        referanseUrl: "https://byggeteknikk.norgips.no/prosjektering/innervegger/veggtabell/veggtabell-w112-vegger-med-to-platelag-se/",
      },
      {
        navn: "Norgips W112 Trestender — Dobbel gips på trestender",
        kortbeskrivelse: "2×12,5 mm gips på trestender. Dokumentert EI 60.",
        beskrivelse: "Ikke-bærende innervegg med trestendere og dobbel gipsplatekledning (2/2) på begge sider. Dokumentert EI 60 iht. Norgips veggtabell for trestender (TE 68 2/2 M50).",
        oppbygging: [
          "2× 12,5 mm Norgips Standard / Hard / Humidboard (hver side)",
          "Trestender C24, min. 48×68 mm, c/c 600 mm",
          "Mineralull 50 mm i hulrom (densitet 13 kg/m³)",
        ...
        brannklasse: "EI 60",
        lydklasse: "R'w 40 dB",
        tykkelse: "ca. 123 mm (med 68 mm stender)",
        leverandor: "Norgips",
        referanse: "Norgips Veggtabell – Trestender W112 (TE 68 2/2 M50)",
        referanseUrl: "https://byggeteknikk.norgips.no/prosjektering/innervegger/veggtabell/veggtabell-trestender/",
        merknader: "Med 98 mm stender oppnås B1=30 min, B2=30 min for bærende vegger.",
      },
      {
        navn: "Norgips W111 Trestender med Brannplate — EI 60",
        kortbeskrivelse: "Enkel 15 mm brannplate på trestender. Dokumentert EI 60.",
        beskrivelse: "Ikke-bærende innervegg med trestendere og enkel Norgips Brannplate 15 mm (type DF) på begge sider. Dokumentert EI 60 iht. Norgips veggtabell for trestender (TE 68 BRN/BRN M50).",
        oppbygging: [
          "1× 15 mm Norgips Brannplate (type DF) (hver side)",
          "Trestender C24, min. 48×68 mm, c/c 600 mm",
          "Mineralull 50 mm i hulrom (densitet 13 kg/m³)",
        ],
        brannklasse: "EI 60",
        lydklasse: "R'w 35 dB",
        tykkelse: "ca. 103 mm (med 68 mm stender)",
        leverandor: "Norgips",
        referanse: "Norgips Veggtabell – Trestender W111 (TE 68 BRN/BRN M50)",
        referanseUrl: "https://byggeteknikk.norgips.no/prosjektering/innervegger/veggtabell/veggtabell-trestender/",
      },
    ],
  },
