...
const Verktoy = () => {
  ...
  const calculateEvacuation = () => {
    ...
    // Simplified calculation based on Norwegian regulations
    // Minimum 1.2m per 150 persons
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Minimum 0.9m for en person, 1.2m per 150 personer
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Totalt antall personer som skal kunne rømme
                  </p>
                </div>
              </div>

              <Button onClick={calculateEvacuation} className="w-full">
                Beregn
              </Button>
                ...
                <div className="space-y-4 pt-4 border-t">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Card className={
                      ...
                      <CardHeader>
                        <CardTitle className="text-base">Minimum bredde</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <p className="text-2xl font-bold">{result.minWidth} m</p>
                        <p className="text-sm text-muted-foreground mt-1">
                          For {persons} personer
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">Kapasitet</CardTitle>
                      </CardHeader>
                      <CardContent>
          ...
          <Card className="shadow-soft">
            <CardHeader>
              <CardTitle className="text-base">Om dette verktøyet</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>
                Dette verktøyet gir en forenklet beregning av rømningsveibredde basert på TEK17 og VTEK.
                Beregningen forutsetter normal mobilitet og tar ikke hensyn til spesielle forhold som kan
                kreve større bredder.
              </p>
              <p>
                Husk å alltid vurdere:
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Bygningens bruk og brukergruppe</li>
                <li>Antall rømningsveier og alternative utganger</li>
                <li>Lokale forhold og geometri</li>
                <li>Krav til universell utforming</li>
              </ul>
            </CardContent>
          </Card>
        </div>
