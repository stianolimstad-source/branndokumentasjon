...
interface BrannArealToolProps {
  /** When provided, shows a "Bruk dette brannarealet" button that returns the result */
  onSelectResult?: (brannareal: number) => void;
}

const BrannArealTool = ({ onSelectResult }: BrannArealToolProps) => {
            ...
            <div className={`p-4 rounded-lg ${
              ...
              {resultat === null ? (
                ...
                <div>
                  ...
                  {onSelectResult && (
                    <Button size="sm" className="mt-3" onClick={() => onSelectResult(resultat)}>
