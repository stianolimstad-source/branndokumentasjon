              ...
              <>
                <tr id="preview-3-1" style={sectionRowStyle}>
                  <td className="border border-gray-400 p-2 font-bold" colSpan={3}>
                    {sp}.1 &nbsp;&nbsp; Kap. 30:41 Bæreevne og stabilitet (Bygningsbrannklasse) <span style={{fontWeight: 'normal', fontStyle: 'italic'}}>(§ 11-4)</span>
                  </td>
                </tr>
                <tr className="bg-gray-100">
            ...
            {(() => {
              ...
              if (formData.roykKontrollKrav && formData.roykKontrollKrav.length > 0) {
                const roykKravMap: Record<string, string> = {
                  ...
                  bf85_royk_brannventilasjon: "For bygninger med inntil 8 etasjer kan brannventilasjonen skje gjennom vindu i trapperom. Alle andre bygninger skal ha røyksjakt som er skilt fra loft i minst A 30 og som har et tverrsnitt på minst 1 m². Sjakten skal gå 20 cm over takflaten.",
                };
                      ...
                      {vis514 && (
                        <tr>
                          ...
                          <td className="border border-gray-400 p-2">
                            ...
                            {etg > 8 && (
                              <p className="text-sm mb-1">I bygning over 8 etasjer gjelder ingen lettelser — fasademateriale skal være K1/Ut1.</p>
                            )}
                          </td>
                          <td className="border border-gray-400 p-2 align-top">ARK</td>
                        </tr>
              ...
              <>
                {formData.ventilasjonRelevant && (
                  <tr>
                    ...
                    <td className="border border-gray-400 p-2">
                      <p className="italic mb-2">BF85 stiller kun det generelle kravet om at anlegget ikke skal medføre økt risiko for brann. Som vurderingsgrunnlag legges preaksepterte ytelser fra TEK17 §11-10 til grunn:</p>
                ...
                {formData.ventilasjonRelevant && ((formData.bygningstype || "").toLowerCase().includes("kraftstasjon") || (formData.bygningsdeler || []).some((d: any) => (d.bygningstype || "").toLowerCase().includes("kraftstasjon"))) && (
                  <tr>
