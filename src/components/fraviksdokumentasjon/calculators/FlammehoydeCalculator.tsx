        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <Label htmlFor="branneffekt-dlg">Q̇ — Branneffekt (kW)</Label>
              <Input id="branneffekt-dlg" type="number" placeholder="f.eks. 3000" value={branneffekt} onChange={(e) => setBranneffekt(e.target.value)} />
            ...
            <div className="space-y-4">
              ...
              {kildeType === "rund" ? (
                <div className="space-y-2">
                  <Input id="diameter-dlg" type="number" step="0.1" placeholder="f.eks. 2" value={diameter} onChange={(e) => setDiameter(e.target.value)} />
                  <p className="text-xs text-muted-foreground">Faktisk diameter (m)</p>
                </div>
              ) : (
                <div className="space-y-2">
                  <Input id="areal-dlg" type="number" step="0.1" placeholder="f.eks. 10" value={areal} onChange={(e) => setAreal(e.target.value)} />
